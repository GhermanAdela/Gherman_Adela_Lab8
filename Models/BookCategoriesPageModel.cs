...
namespace Gherman_Adela_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Gherman_Adela_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Gherman_Adela_Lab8Context context,
